...
@section('contents')
    ...
    <!-- Modal Store/Update -->
    <div id="modal-sejarah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-sejarahLabel"
        aria-hidden="true">
        <form action="{{ route('sejarah.store') }}" method="post" id="form-sejarah" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-sejarahLabel">Form Sejarah</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control"
                                accept="image/*">
                            <small class="text-muted">Maks 2MB. Kosongkan saat edit jika tidak ingin mengganti file.</small>
...
@push('scripts')
    <script src="{{ asset('js/page/sejarah/list.js') }}"></script>
@endpush
