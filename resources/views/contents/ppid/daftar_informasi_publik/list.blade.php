{{-- resources/views/contents/ppid/daftar_informasi_publik/list.blade.php --}}
@extends('layouts.app')
...
@section('contents')
    ...
    <!-- Modal Store/Update -->
    <div id="modal-daftar-informasi-publik" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-daftar-informasi-publikLabel" aria-hidden="true">
        <form action="{{ route('ppid-daftar-informasi-publik.store') }}" method="post" id="form-daftar-informasi-publik"
            enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-daftar-informasi-publikLabel">Form Daftar Informasi Publik</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/ppid/daftar_informasi_publik/list.js') }}"></script>
@endpush