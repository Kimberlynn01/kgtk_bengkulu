{{-- resources/views/contents/informasi_berkala/list.blade.php --}}
@extends('layouts.app')
...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Informasi Berkala</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-informasi-berkala" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-informasi-berkalaLabel" aria-hidden="true">
        <form action="{{ route('informasi-berkala.store') }}" method="post" id="form-informasi-berkala"
            enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-informasi-berkalaLabel">Form Informasi Berkala</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/informasi_berkala/list.js') }}"></script>
@endpush