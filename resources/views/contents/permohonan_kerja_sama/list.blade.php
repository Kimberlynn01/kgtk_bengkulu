...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Permohonan Kerja Sama</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-permohonan-kerja-sama" class="modal fade" tabindex="-1" role="dialog">
        <form action="{{ route('permohonan_kerja_sama.store') }}" method="post" id="form-permohonan-kerja-sama">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Permohonan Kerja Sama</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/permohonan_kerja_sama/list.js') }}"></script>
@endpush
