{{-- resources/views/contents/ppid/visi_misi/list.blade.php --}}
@extends('layouts.app')
...
@section('contents')
    ...
    <!-- Modal Store/Update -->
    <div id="modal-visi-misi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-visi-misiLabel"
        aria-hidden="true">
        <form action="{{ route('ppid-visi-misi.store') }}" method="post" id="form-visi-misi" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-visi-misiLabel">Form Visi Misi PPID</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/ppid/visi_misi/list.js') }}"></script>
@endpush