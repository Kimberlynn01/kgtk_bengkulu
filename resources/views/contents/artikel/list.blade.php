...
@section('contents')
    <div class="row">
        <div class="col-sm-12 text-right mb-2">
            <div class="bookmark">
                <ul>
                    <li><a href="javascript:void(0)" class="btn-tambah" title="Tambah Artikel"><i
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Artikel Publikasi</h5>
                </div>
                <div class="card-body">
    ...
    <div id="modal-artikel" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-artikelLabel"
        aria-hidden="true">
        <form action="{{ route('artikel.store') }}" method="post" id="form-artikel" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-artikelLabel">Form Artikel</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/artikel/list.js') }}"></script>
@endpush
