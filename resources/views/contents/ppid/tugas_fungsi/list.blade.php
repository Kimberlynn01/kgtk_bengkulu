{{-- resources/views/contents/ppid/tugas_fungsi/list.blade.php --}}
@extends('layouts.app')
...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Tugas Fungsi PPID</h5>
                </div>
                <div class="card-body">
    ...
    <div id="modal-tugas-fungsi" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-tugas-fungsiLabel"
        aria-hidden="true">
        <form action="{{ route('ppid-tugas-fungsi.store') }}" method="post" id="form-tugas-fungsi"
            enctype="multipart/form-data">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tugas-fungsiLabel">Form Tugas Fungsi PPID</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/ppid/tugas_fungsi/list.js') }}"></script>
@endpush