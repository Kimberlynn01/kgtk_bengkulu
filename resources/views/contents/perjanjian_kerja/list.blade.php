...
@section('contents')
    ...
    <!-- Modal Store/Update -->
    <div id="modal-perjanjian-kerja" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-perjanjian-kerjaLabel"
        aria-hidden="true">
        <form action="{{ route('perjanjian_kerja.store') }}" method="post" id="form-perjanjian-kerja" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-perjanjian-kerjaLabel">Form Perjanjian Kerja</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/perjanjian_kerja/list.js') }}"></script>
@endpush
