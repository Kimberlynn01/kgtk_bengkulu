...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Perilaku & Core Value</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-perilaku-core-value" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-perilaku-core-valueLabel"
        aria-hidden="true">
        <form action="{{ route('perilaku_core_value.store') }}" method="post" id="form-perilaku-core-value" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-perilaku-core-valueLabel">Form Perilaku & Core Value</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/perilaku_core_value/list.js') }}"></script>
@endpush
