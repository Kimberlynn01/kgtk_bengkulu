...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Rencana Strategis</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-rencana-strategis" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-rencana-strategisLabel"
        aria-hidden="true">
        <form action="{{ route('rencana_strategis.store') }}" method="post" id="form-rencana-strategis" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-rencana-strategisLabel">Form Rencana Strategis</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/rencana_strategis/list.js') }}"></script>
@endpush
