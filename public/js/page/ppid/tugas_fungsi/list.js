// public/js/page/ppid/tugas_fungsi/list.js
let table;
...
$(() => {
    table = $("#table-data").DataTable({
        ...
        processing: true,
        ajax: {
            url: BASE_URL + "ppid/tugas-fungsi/data",
            type: "get",
            dataType: "json",
        },
        columns: [
    ...
    $("#table-data").on("click", ".btn-update", function () {
        ...
        $.get(BASE_URL + "ppid/tugas-fungsi/edit/" + id, (res) => {
            if (res.status) {
                let data = res.data;
                $("#id").val(data.id);
    ...
    $("#form-tugas-fungsi").on("submit", function (e) {
        ...
        let id = $("#id").val();
        let url = id
            ? BASE_URL + "ppid/tugas-fungsi/update"
            : BASE_URL + "ppid/tugas-fungsi/store";
    ...
    $("#table-data").on("click", ".btn-delete", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post(
                    BASE_URL + "ppid/tugas-fungsi/delete",
