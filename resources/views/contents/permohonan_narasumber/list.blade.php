...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Permohonan Narasumber</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-permohonan-narasumber" class="modal fade" tabindex="-1" role="dialog">
        <form action="{{ route('permohonan_narasumber.store') }}" method="post" id="form-permohonan-narasumber">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Permohonan Narasumber</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/permohonan_narasumber/list.js') }}"></script>
@endpush
