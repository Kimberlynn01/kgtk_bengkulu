                ...
                <div class="col-xl-6 col-50 box-col-6 des-xl-50">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="code-box-copy">
                                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#sell-overview"
                                    title="Copy"><i class="icofont icofont-copy-alt"></i></button>
                ...
                <div class="col-xl-12 recent-order-sec">
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <th>
                                                <div class="setting-list">
                                                    <ul class="list-unstyled setting-option">
                                                        ...
                                                        <li><i class="view-html fa fa-code font-primary"></i>
                                                        </li>
                                                        <li><i
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                    ...
                                                    <div class="media-body"><a href="product-page.html"><span>Yellow New
                                            ...
                                            <td><img class="img-fluid" src="../assets/images/dashboard/graph-1.png"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="product-page.html"><span>Sony Brand
                                            ...
                                            <td><img class="img-fluid" src="../assets/images/dashboard/graph-2.png"
                                                    alt="" data-original-title="" title=""></td>
                                            <td>
                                                <p>$548526</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="product-page.html"><span>Beautiful
                                            ...
                                            <td><img class="img-fluid" src="../assets/images/dashboard/graph-3.png"
                                                    alt="" data-original-title="" title=""></td>
                                            <td>
                                                <p>$589565</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="product-page.html"><span>Marco M
                                                                Kely
                                                                Handbeg</span></a></div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img class="img-fluid" src="../assets/images/dashboard/graph-4.png"
                                                    alt="" data-original-title="" title=""></td>
                                            <td>
                                                <p>$125424 </p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        data-original-title="" title="">
                                                    <div class="media-body"><a href="product-page.html"><span>Being
                                                                Human
                                            ...
                                            <td><img class="img-fluid" src="../assets/images/dashboard/graph-5.png"
                                                    alt="" data-original-title="" title=""></td>
                                            <td>
                                                <p>$112103</p>
                                            </td>
                            ...
                            <div class="code-box-copy">
                                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#recent-order"
                                    title="Copy"><i class="icofont icofont-copy-alt"></i></button>
                ...
                <div class="col-xl-12 box-col-6 des-xl-50">
                    <div class="card trasaction-sec">
                            ...
                            <div class="header-top d-sm-flex align-items-center">
                                ...
                                <div class="setting-list">
                                    <ul class="list-unstyled setting-option">
                                        ...
                                        <li><i class="icofont icofont-maximize full-card font-secondary"></i>
                                        </li>
                                        <li><i class="icofont icofont-minus minimize-card font-secondary"></i>
                                        </li>
                                        <li><i class="icofont icofont-refresh reload-card font-secondary"></i>
                                        </li>
                                        <li><i class="icofont icofont-error close-card font-secondary"></i>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="code-box-copy">
                                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#transaction"
                                    title="Copy"><i class="icofont icofont-copy-alt"></i></button>
