...
@section('contents')
                ...
                <div class="bookmark">
                    <ul>
                        <li><a href="javascript:void(0)" data-container="body" data-bs-toggle="popover" data-placement="top"
                                title="Tambah Menu" data-original-title="Tables" class="btn-tambah"><i
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar menu yang terdaftar dalam sistem</h5>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="div-menu-type div-main">
                                        ...
                                        @foreach (icons() as $key => $value)
                                            <tr>
                                                <td class="text-center" style="width: 30%;"><i
                                                        class="icofont {{ $value }} fa-2x text-primary pilih-icon"
                                                        data-icon_name="{{ $value }}"></i></td>
                                                <td><span class="pilih-icon" data-icon_name="icofont {{ $value }}">
                                                        {{ $value }}
                                                    </span></td>
                                            </tr>
                                        @endforeach
                            ...
                            <div class="form-group">
                                <label for="menu_group_id">Nama Grup Menu</label>
                                <select name="menu_group_id" id="menu_group_id" class="form-control"
                                    style="width: 100%;">
                                    <option value="" selected disabled>Pilih Grup Menu</option>
                                    @foreach ($menuGroups as $item)
                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                <div id="error-menu_group_id"></div>
                            </div>
                        </div>
    ...
    <!-- sample modal content -->
    <div id="modal-update-menu" class="modal fade" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="div-menu-type div-main">
                                        ...
                                        @foreach (icons() as $key => $value)
                                            <tr>
                                                <td class="text-center" style="width: 30%;"><i
                                                        class="icofont {{ $value }} fa-2x text-primary pilih-icon"
                                                        data-icon_name="{{ $value }}"></i></td>
                                                <td><span class="pilih-icon"
                                                        data-icon_name="icofont {{ $value }}">
                                                        {{ $value }}
                                                    </span></td>
                                            </tr>
                                        @endforeach
                            ...
                            <div class="form-group">
                                <label for="update-menu_group_id">Nama Grup Menu</label>
                                <select name="menu_group_id" id="update-menu_group_id" class="form-control"
                                    style="width: 100%;">
                                    <option value="" selected disabled>Pilih Grup Menu</option>
                                    @foreach ($menuGroups as $item)
                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                ...
                                <div id="error-update-menu_group_id"></div>
                            </div>
                        </div>
                        <div class="div-menu-type div-child" style="display: none">
                            <div class="form-group">
                                <label for="update-parent_id">Nama Menu Utama</label>
                                <select name="parent_id" id="update-parent_id" class="form-control"
                                    style="width: 100%;">
                                    <option value="" selected disabled>Pilih Menu Utama</option>
                                </select>
