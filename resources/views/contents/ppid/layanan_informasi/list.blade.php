{{-- resources/views/contents/ppid/layanan_informasi/list.blade.php --}}
@extends('layouts.app')
...
@section('contents')
        ...
        <div class="col-sm-12">
            <div class="card b-1-primary">
                <div class="card-header pb-0">
                    <h5>Daftar Layanan Informasi</h5>
                </div>
                <div class="card-body">
    ...
    <!-- Modal Store/Update -->
    <div id="modal-layanan-informasi" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-layanan-informasiLabel" aria-hidden="true">
        <form action="{{ route('ppid-layanan-informasi.store') }}" method="post" id="form-layanan-informasi"
            enctype="multipart/form-data">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-layanan-informasiLabel">Form Layanan Informasi</h5>
...
@push('scripts')
    <script src="{{ asset('js/page/ppid/layanan_informasi/list.js') }}"></script>
@endpush